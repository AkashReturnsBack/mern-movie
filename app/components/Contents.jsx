    ...
    return (
        <div className='container h-screen overflow-y-scroll max-w-[75rem] py-4 font-montserrat space-y-8'>
            ...
            <div className='flex items-center justify-between'>
                <div className='bg-gray flex px-4 py-3 items-center w-[50%]'>
                ...
                <div className='flex items-center w-[35%] cursor-pointer justify-around'>
                    <div className='bg-gray flex items-center gap-1 w-fit px-4 py-3 rounded-full'>
                        Happy Birthday!
            ...
            <div className='w-full relative h-[23rem]'>
                ...
                <div className='absolute top-[30%] translate-x-8 space-y-3 text-white '>
                    ...
                    <p className='font-medium text-lg'>The Badass Mafia Story <WordBreak /> Ever Seen</p>
                    <button className='flex items-center gap-2 bg-gray text-black px-4 py-2 rounded-sm'><IoPlayCircleOutline className='text-2xl' />Watch Now</button>
                </div>
            </div>
            {/* third section */}
            <div className='space-y-6'>
                <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-6'>
                        <div className='flex items-center gap-1 bg-gray px-6 py-2 rounded-full'>Filter <IoIosArrowDown className='text-2xl' /></div>
                        <div className='font-medium bg-gray rounded-full px-6 py-2'>See All</div>
                    </div>
                </div>
                <div className='flex h-full gap-8 overflow-x-scroll'>
                    {movies?.map(item => {
                        return <div className='min-w-[12rem] relative gradient-overlay' key={uuidv4()}>
